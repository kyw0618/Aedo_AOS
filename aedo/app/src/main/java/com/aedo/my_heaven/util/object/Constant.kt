...
//    const val BASE_URL_TEST="http://106.10.53.93/"
    ...
    const val PLACE_NUMBER = "PLACE_NUMBER"
    ...
    const val SEARCH_EOD_TIME = "SEARCH_EOD_TIME"

    const val SEARCH_COFFIN_DATA = "SEARCH_COFFIN_DATA"
    const val SEARCH_COFFIN_TIME = "SEARCH_COFFIN_TIME"

    const val SEARCH_DOFP_DATA = "SEARCH_DOFP_DATA"
    const val SEARCH_DOFP_TIME = "SEARCH_DOFP_TIME"

    const val SEARCH_BURIED = "SEARCH_BURIED"
    const val SEARCH_PLACE = "SEARCH_PLACE"
    const val SEARCH_PLACE_NUMBER = "SEARCH_PLACE_NUMBER"
    ...
    const val MY_ORDER_WORD = "MY_ORDER_WORD"
    const val MY_ORDER_COMPANY = "MY_ORDER_COMPANY"
    const val MY_ORDER_CREATED = "MY_ORDER_CREATED"
    const val MY_ORDER_ORDER_COMPLETE = "MY_ORDER_ORDER_COMPLETE"
    const val MY_ORDER_MERCHANT_UID = "MY_ORDER_MERCHANT_UID"
    const val MY_ORDER_ID = "MY_ORDER_ID"
