...
import com.aedo.my_heaven.databinding.FragmentAfterOrderBinding
...
class AfterOrderFragment : Fragment() {

    private lateinit var mBinding : FragmentAfterOrderBinding
    ...
    override fun onCreateView(
        ...
        mBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_after_order, container, false)
